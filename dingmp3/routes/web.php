...
Route::get('bai-hat.html', [App\Http\Controllers\SongController::class, 'show']);

Route::get('tim-kiem.html', [App\Http\Controllers\SongController::class, 'search']);

Route::get('mv/{id}-{slug}.html', [App\Http\Controllers\MVController::class, 'index']);

Route::get('mv.html', [App\Http\Controllers\MVController::class, 'show']);
Route::get('ca-si/{id}-{slug}.html', [App\Http\Controllers\SingerController::class, 'index']);

Route::get('ca-si.html', [App\Http\Controllers\SingerController::class, 'show']);


Route::get('the-loai.html', [App\Http\Controllers\MenuController::class, 'show']);
Route::get('the-loai/{id}.html', [App\Http\Controllers\MenuController::class, 'index']);

Route::get('album/{id}-{slug}.html', [App\Http\Controllers\AlbumController::class, 'index']);

Route::get('album.html', [App\Http\Controllers\AlbumController::class, 'show']);

Route::get('list/{id}-{slug}.html', [App\Http\Controllers\ListController::class, 'index']);
Route::get('list.html', [App\Http\Controllers\ListController::class, 'show']);
